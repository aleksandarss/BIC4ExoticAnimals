    ...
    <div class="table-container is-fullwidth">
        <table class="table is-fullwidth is-hoverable">
            ...
            <tr class="title is-6">
                ...
                <table-element element-type="th" class="is-fixed-width">Animals</table-element>
            ...
            <tr v-for="specimen in species" :key="specimen.id">
                ...
                <table-element element-type="td">
                    <p class="buttons">
                        <a :href="'/species/' + specimen.slug + '/edit'" class="button is-info is-outlined ">
                            <span class="icon">
                              <i class="fa fa-edit"></i>
                            </span>
                        </a>
                        <button :disabled="specimen.animals.length > 0" @click="openDeleteModal(specimen)" class="button is-danger is-outlined">
                            <span class="icon">
